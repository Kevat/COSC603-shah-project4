 ...
 *
 * @generatedBy CodePro at 4/1/16 2:01 PM
 * @author Kevat.Shah
...
public class VendingMachineTest {
	...
	public void testAddItem_4()
		...
		VendingMachineItem item2 = new VendingMachineItem("Item 2", 1.0);
		String code = "A";
	...
	public void testAddItem_5(){
		...
		VendingMachineItem vmItem1 = new VendingMachineItem("Item 1", 10);
		VendingMachineItem vmItem2 = new VendingMachineItem("Item 2", 10);
		VendingMachineItem vmItem3 = new VendingMachineItem("Item 3", 10);
		VendingMachineItem vmItem4 = new VendingMachineItem("Item 4", 10);
	...
	/**
	 * Created manually to test the method makePurchase with a valid item 
	 * 
	 */
	@Test
